...
\subsection{Darklang}
\xxx{Darklang\footnote{\url{https://darklang.com/} [visited on 2024-04-22][online]} is a cloud-based low-code programming system for building web application backends created by Paul Biggar.
}
