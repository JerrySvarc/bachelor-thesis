...
\begin{listing}[htbp]
	\caption{Counter task implemeneted using the \emph{Data-Driven UI} prototype system.}
	\label{fig:counter-res}
	\begin{lstlisting}
<!DOCTYPE html>
<html lang="en">
<head>
...
<body  p-4">
    ...
    function renderApp(data) {
      ...
      app.innerHTML = `
        ...
        <div data-key="button">
          <button  id="plusOneButton" >${data.button}</button>
        </div>
        </div>
      `;
    ...
    function setupEventListeners(data) {
      ...
      if (plusOneButton) plusOneButton.addEventListener('click', (event) => plusOne(event, data));
    }
