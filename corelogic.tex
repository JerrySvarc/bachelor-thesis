...
Now that all necessary operations are defined, we focus on the creation process of a simple TODO list UI.
We see the steps of the entire process in Figure~\ref{fig:simple-todo-steps}.

The process starts by uploading JSON data we see in Figure~\ref{fig:simple-todo-json} to the system.
The system analyzes it and creates a UI skeleton displaying the hole menus for elements which can be created based on the input data.
...
\begin{figure}[htbp]
    ...
    \end{lstlisting}
	\caption{Example JSON data}\label{fig:simple-todo-json}
\end{figure}
...
\begin{figure}[p]
	...
	\begin{tikzpicture}[
		...
		\node [right=of json] (todo1) {\includegraphics[width=0.35\textwidth]{img/todo-simple-1.pdf}};
		\node [below=of json] (todo2) {\includegraphics[width=0.35\textwidth]{img/todo-simple-2.pdf}};
		\node [right=of todo2] (todo3) {\includegraphics[width=0.35\textwidth]{img/todo-simple-4.pdf}};
		\node [below=of todo2] (todo4) {\includegraphics[width=0.35\textwidth]{img/todo-simple-5.pdf}};
		\node [right=of todo4] (todo5) {\includegraphics[width=0.35\textwidth]{img/todo-simple-6.pdf}};
