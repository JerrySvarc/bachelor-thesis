...
\begin{itemize}
	...
	\item \texttt{CustomWrapper} and \texttt{CustomElement} types are handled to generat the user-defined elements
\end{itemize}
...
This implementation is a proof of concept for our data-driven, low-code approach to web application development and
it demonstrates how a functional system can realize the design principles and core logic described in previous chapters.
