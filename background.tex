...
In this section, we will introduce the Elm programming language,
and describe tools that enable the development of browser-based applications in F\#, such as the F\# to JavaScript compiler Fable and the Elmish architecture.

\subsection{JSON}
\xxx{//TODO: Nasel jsem tuto specifikaci https://www.rfc-editor.org/rfc/rfc8259}
...
The functional reactive programming approach applies pure functional programming paradigms to time-varying values, as described by \citet{Elliott_Hudak_1997}.
...
It combines functional programming with imperative and object-oriented paradigms, offering strong type inference, data-rich programming, and concurrency support.
We chose F\# for implementing our low-code programming system due to its strong type system, functional programming capabilities, and seamless integration with the .NET ecosystem.
