...
\xxx{In Chapter \ref{chap:background}, we will introduce the concept of low-code development along with some tools from the low-code development category.
Then, we will explore the approach of output-directed programming as described by \citet{Hempel_Lubin_Chugh_2019}.
Lastly, we will introduce some popular web development tools and tools used during the creation of the project.  }
...
\xxx{In Chapter \ref{chap:devdocs}, we will provide documentation for developers who 
want to deploy, modify or extend the system. }

\xxx{In Chapter \ref{chap:usrdocs}, we will provide for users. We will describe the functionality of the user interface and steps involved in 
creating a web application using the system.  }

\xxx{In Chapter \ref{chap:results}, we will explore the functionality and usefulness of the programming system by 
